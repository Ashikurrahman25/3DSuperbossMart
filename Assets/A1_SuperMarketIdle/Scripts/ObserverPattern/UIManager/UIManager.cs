...
public class UIManager : Manager
{
    ...
    public GameObject menu, inGameScreen, InGameMoney, InGameMoneyImage, settingsWindow, upgradeWindow, truckUpgradeWindow, dragToMoveScreen, splashScreenVideo, infoPanel;
