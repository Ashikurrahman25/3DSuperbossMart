...
public class SettingsMenuActor : MonoBehaviour
{
    ...
    public void Share()
    {
        ...
        shareSheet.AddText("Hey I am playing this awesome game called 3D Supermart Boss. Download Now-");
        shareSheet.AddURL(URLString.URLWithPath("https://play.google.com/store/apps/dev?id=6826413416190098662"));
